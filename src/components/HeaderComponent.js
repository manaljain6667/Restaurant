...
// NavLink, it will add an a tag to that link and also automatically add the active if the URL matches what is being specified in the NavLink there. 
                  ...
                  <div className="container">
                    ...
                    <NavbarBrand className="mr-auto" href="/"><img src='assets/images/logo.png' height="30" width="41" alt='Ristorante Con Fusion' /></NavbarBrand>
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            ...
                            <Nav className="ml-auto" Navbar> {/*ml-auto this way we give left margin as much as possible*/}               
                                <NavItem>
